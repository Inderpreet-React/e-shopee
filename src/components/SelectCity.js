...
export default function SelectCity({ cName }) {
	return (
		...
		>
			...
			<option value="Ajmer">Ajmer</option> <option value="Akola">Akola</option>
			...
			<option value="Angul">Angul</option> <option value="Anjaw">Anjaw</option>
			...
			<option value="Daman">Daman</option> <option value="Damoh">Damoh</option>
			<option value="Dantewada">Dantewada</option>
			<option value="Darbhanga">Darbhanga</option>
			<option value="Darjeeling">Darjeeling</option>
			<option value="Darrang">Darrang</option>
			<option value="Datia">Datia</option> <option value="Dausa">Dausa</option>
			...
			<option value="Dindori">Dindori</option> <option value="Diu">Diu</option>
			<option value="Doda">Doda</option> <option value="Dumka">Dumka</option>
			...
			<option value="Erode">Erode</option> <option value="Etah">Etah</option>
			...
			<option value="Gumla">Gumla</option> <option value="Guna">Guna</option>
			...
			<option value="Koriya">Koriya</option> <option value="Kota">Kota</option>
			...
			<option value="Mamit">Mamit</option> <option value="Mandi">Mandi</option>
			<option value="Mandla">Mandla</option>
			<option value="Mandsaur">Mandsaur</option>
			<option value="Mandya">Mandya</option>
			<option value="Mansa">Mansa</option>
			<option value="Marigaon">Marigaon</option>
			<option value="Mathura">Mathura</option> <option value="Mau">Mau</option>
			...
			<option value="Palamu">Palamu</option> <option value="Pali">Pali</option>
			...
			<option value="Puri">Puri</option> <option value="Purnia">Purnia</option>
			...
			<option value="Reasi">Reasi</option> <option value="Rewa">Rewa</option>
			...
			<option value="Saiha">Saiha</option> <option value="Salem">Salem</option>
			...
			<option value="Sidhi">Sidhi</option> <option value="Sikar">Sikar</option>
			...
			<option value="Siwan">Siwan</option> <option value="Solan">Solan</option>
			...
			<option value="Umaria">Umaria</option> <option value="Una">Una</option>
